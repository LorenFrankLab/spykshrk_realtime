...
def main(path_base, rat_name, day, epoch, shift_amt, path_out):
    ...
    lik['ripple_grp']=-1
    lik=lik.reset_index()
    lik2 = trodes2SS.convert_dan_posterior_to_xarray(lik,tetrodes,velocity_thresh_for_enc_dec, encode_settings, decode_settings, sungod_trans_mat, order, shift_amount)
    lik2.to_netcdf(likelihood_file_name)
